...
class SignUpAuth {
  ...
  void auth() async {
    FirebaseAuth.instance
      ...
      messageShow(
          this._context, "Sign Up Complete", "Please Log-in to Enjoy this app");
    }).catchError((e) {
      if (e.toString() ==
          "[firebase_auth/email-already-in-use] The email address is already in use by another account.")
        messageShow(
            this._context, "Sign-Up Error", "Email Already Used by other User");
      else
        messageShow(this._context, "Sign-Up Error",
